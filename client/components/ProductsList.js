...
class ProductsList extends React.Component {
	...
	filterProducts(evt) {
		if (evt) {
			...
			if (evt.target.value === 'all') {
				...
				this.props.filterByCategory(this.state.products, this.state.orderBy, evt.target.value);
			}
		} else {
			if (this.state.category === 'all') {
				this.props.filterByAll(this.props.products, this.state.orderBy);
			} else {
				this.props.filterByCategory(this.props.products, this.state.orderBy, this.state.category);
			}
		}
	}
	...
	render() {
		let products = this.state.filteredAndOrdered.length ? this.state.filteredAndOrdered : [];
			...
			<div>
				<div className="menu-bar">
					<div>
						...
						<select id="dropdown" value={this.state.orderBy} onChange={this.orderProducts}>
...
const mapDispatch = (dispatch) => {
	return {
		...
		filterByAll: (products, orderBy) => dispatch(filterByAll(products, orderBy)),
