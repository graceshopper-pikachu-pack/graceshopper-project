...
const products = [
	{
		...
		imageUrl:
			'https://www.greatadventuresafaris.com/wp-content/uploads/Shoebill-storck-boat-rip-inMurchison-falls-National-Park-1200x675.jpg',
		productDescription:
	...
	},
	{
		...
		price: 250,
		funFact:
			'Schools of clownfish have a strict hierarchy, with the most aggressive female at the top.  All clownfish are born male. When the dominant female dies, the dominant male will turn itself into a female.',
	},
	{
	...
	},
	{
		...
		imageUrl:
			'https://robbreport.com/wp-content/uploads/2021/01/kate-BRnnJ6vVNdY-unsplash-1.jpg?w=1000',
	...
	},
	{
		...
		latinName: 'Zygoptera',
		funFact:
			'With a lifespan that may last from a few weeks to several years, depending on the species, most often, once they reach adulthood, they will only live a few weeks. During that short span, they lay hundreds or thousands of eggs. Depending on the water temperature, incubation may take anywhere from 5 days to several months.',
	},
	{
		...
		funFact:
			"Egg laying mammals are called monotremes. There are only three monotremes in the world: the long-beaked echidna, short-beaked echidna, and platypus. Both male and female echidnas have a pouch on the belly making it difficult to tell one from the other. The echidna's snout is very sensitive and can feel vibrations",
	},
	{
		...
		latinName: 'Coronatus',
		funFact:
			'A crowned eagle can swoop after prey in the air at 100 miles (160 kilometers) per hour yet brake to a halt within 20 feet (6 meters). It pushes its powerful wings against the air currents to slow down. The flight of the crowned eagle is remarkably quiet, much like the silent flight of owls.',
	},
	{
		...
		latinName: 'Iguanidae',
		funFact:
			'Marine iguanas of the Galápagos Islands (off the coast of Ecuador) are excellent swimmers. n the Animal Kingdom, males often have the brightest colors, but not among green iguanas; males are often a bright orange, females are green, and the juveniles are a brilliant green.',
	},
	{
		...
		funFact:
			'The golden mantella is the most well known. Individuals can be yellow, bright orange, or orange-red in color. The variegated mantella lives in the high grasslands of Central Madagascar. It burrows during the dry season to keep from drying out.',
	},
	{
